...
- `%(current_date_day)d` - текущий день
- `%(current_date_mount)d` - текущий месяц
- `%(current_date_year)d` - текущий год (2 числа)
- `%(current_date_year_full)d` - текущий год (4 числа) 
- `%(current_time_hour)d` - текущий час
- `%(current_time_minute)d` - текущая минута
